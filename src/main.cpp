...
uint256 hashGenesisBlock("0x213a1daddaff5146dce77b1ca20e6b8c5e2055ed81c2bce18412ba5b27b4d092");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // LIBRE: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "LIBRE Signed Message:\n";
...
{
    // LIBRE: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 90000000); // LIBRE: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // LIBRE: 3.5 days
static const int64 nTargetSpacing = 150; // LIBRE: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // LIBRE: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // LIBRE: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // LIBRE: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9b4681f24aceb9564b020179368ea39e9576408d6811cfe9c62577e9943b8ea5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("048211a8e1c9a91d975fa3903b0acd6e6c5494e5b3c3aecfee8af8437c094f785988c6506dc635a3d4e04889dff2292018d30860eac6b291be14e219ae6318cb8d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1565771595;
        block.nBits    = 504365644;
        block.nNonce   = 1568543776;

        if (fTestNet)
        {
            block.nTime    = 1565771595;
            block.nNonce   = 1594909281;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x07f7b20b7ea1f9b84323163938fae21bac072c6c14e5864ab72c5dbdbff75125"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // LIBRE: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("LIBREMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("LIBREMiner : ProcessBlock, block not accepted");
    }
